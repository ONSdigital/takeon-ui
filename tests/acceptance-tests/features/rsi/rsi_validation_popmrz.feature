Feature: RSI Validation PoPMRZ
  ...
  Scenario Outline: RSI LU-5033 - PoPMRZ rule A - Validation Check on form 5
    ...
    Examples:
      ...
      | 0023   | 201903              | 201904             | 49900534932 | 0               | 99              | 1000            | false  | less than    | 10%            |
      | 0023   | 201903              | 201904             | 49900551526 | 0               | 100             | 1000            | false  | equal to     | 10%            |
      | 0023   | 201903              | 201904             | 49900567891 | 0               | 101             | 1000            | true   | greater than | 10%            |
  ...
  Scenario Outline: RSI LU-5033 - PoPMRZ rule A - Validation Check on form 6
    ...
    Examples:
      | survey | previousPeriodValue | currentPeriodValue | reference   | cpInternetSales | ppInternetSales | ppTotalTurnover | result | operator     | thresholdValue |
      | 0023   | 201903              | 201904             | 49900613746 | 0               | 99              | 1000            | false  | less than    | 10%            |
      | 0023   | 201903              | 201904             | 49900617217 | 0               | 100             | 1000            | false  | equal to     | 10%            |
      | 0023   | 201903              | 201904             | 49900672013 | 0               | 101             | 1000            | true   | greater than | 10%            |
  ...
  Scenario Outline: RSI LU-5033 - PoPMRZ rule A - Validation Check on form 7
    ...
    Examples:
      | survey | previousPeriodValue | currentPeriodValue | reference   | cpInternetSales | ppInternetSales | ppTotalTurnover | result | operator     | thresholdValue |
      | 0023   | 201903              | 201904             | 49900748571 | 0               | 99              | 1000            | false  | less than    | 10%            |
      | 0023   | 201903              | 201904             | 49900756292 | 0               | 100             | 1000            | false  | equal to     | 10%            |
      | 0023   | 201903              | 201904             | 49900767172 | 0               | 101             | 1000            | true   | greater than | 10%            |
      | 0023   | 201903              | 201904             | 49900791240 | 0               | 0               | 1000            | false  | less than    | 10%            |
      | 0023   | 201903              | 201904             | 49900792013 | 0               | 0               | 0               | false  | less than    | 10%            |
