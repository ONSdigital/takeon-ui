Feature: RSI Survey - Override Checkboxes - Validation Value Present SIC (VPSIC)
  ...
  Scenario Outline: LU-7XXX - Check Override functionality for Value Present SIC (VPSIC) Validation for RSI Survey form 7
  ...
  Scenario Outline: LU-7XXX - Check Override functionality for Value is Blank (VB) Validation for RSI Survey form 5,6 and 7
