Feature: RSI Validation Previous Period Value Blank (PPVB)
  ...
  Scenario Outline: RSI LU-6757 - Previous Period Value Blank Validation on forms 5
    Given I search for the survey "0023" with <reference> for the previous period <PPeriod>
    And has the internet sales value <ppInternetSales> out of total turnover value <ppTotalTurnover>
    When I search for the survey "0023" with <reference> for the current period <CPeriod>
    ...
    Examples:
      ...
      | 201903  | 201904  | 49900534932 | 1               | 0               | 1               | 2               | This value was blank in the previous period | not be             |
      | 201903  | 201904  | 49900534932 | 0               | 1               | 1               | 2               | This value was blank in the previous period | not be             |
  ...
  Scenario Outline: RSI LU-6757 - Previous Period Value Blank Validation on forms 6
    ...
    Examples:
      ...
      | 201903  | 201904  | 49900613746 | 1               | 0               | 1               | 2               | This value was blank in the previous period | not be             |
      | 201903  | 201904  | 49900613746 | 0               | 1               | 1               | 2               | This value was blank in the previous period | not be             |
  ...
  Scenario Outline: RSI LU-6757 - Previous Period Value Blank Validation on forms 7
    ...
    Examples:
      ...
      | 201903  | 201904  | 49900767172 | 1               | 0               | 1               | 2               | This value was blank in the previous period | not be             |
      | 201903  | 201904  | 49900767172 | 0               | 1               | 1               | 2               | This value was blank in the previous period | not be             |
