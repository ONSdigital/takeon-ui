Feature: RSI Survey - check the date adjusted response values for date anomalies
  ...
  Scenario Outline: SPP-1711 - check the adjusted responses on form 5
    ...
    Examples:
      ...
      | 12000534932 | 201812 | defaults to expected for blank start date | blank           | 20190420      | 100,101     | decreased        |
      | 12000534932 | 201812 | defaults to expected for blank end date   | 20190320        | blank         | 100,101     | decreased        |
      | 12000534932 | 201812 | blank date range                          | blank           | blank         | 200,202     | decreased        |
  ...
  Scenario Outline: SPP-1670 - check the adjusted responses on form 6
    ...
    Examples:
      ...
      | 12000694171 | 201904 | 100,101,5,4,3,2,1                         | outside date range                        | 20190704        | 20190728      | blank            |
      | 12000694171 | 201904 | 100,101,5,4,3,2,1                         | start date greater than end date          | 20190428        | 20190404      | blank            |
      | 12000694171 | 201904 | blank,blank,blank,blank,blank,blank,blank | date range with blank variables           | 20190404        | 20190428      | blank            |
  ...
  Scenario Outline: SPP-1670 - check the adjusted responses on form 7
    ...
    Examples:
      ...
      | 12000818161 | 201903 | 100,101,5,4,3,2,1                         | outside date range                        | 20190704        | 20190728      | blank            |
      | 12000818161 | 201903 | 100,101,5,4,3,2,1                         | start date greater than end date          | 20190327        | 20190304      | blank            |
      | 12000818161 | 201903 | blank,blank,blank,blank,blank,blank,blank | date range with blank variables           | 20190304        | 20190327      | blank            |
      | 12000791240 | 201904 | 6,5,4,3,2,1                               | 25 days short period date range           | 20190404        | 20190420      | decreased        |
