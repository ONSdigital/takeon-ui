Feature: RSI Validation Value Present SIC (VPSIC)
  ...
  Scenario Outline: LU-6829 - Value Present SIC (VPSIC) Validation for RSI Survey form 7
    Given I search for the survey "0023" with <reference> for the period <period> with SIC code <SIC>
    ...
    Examples:
      ...
      | 201903 | 49900818161 | 43700 | 0        | Q21      | Check the response to this question | not be             |
      | 201904 | 49900818161 | 43700 | 1        | Q21      | Check the response to this question | be                 |
