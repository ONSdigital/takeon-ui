Feature: RSI Survey - Validation Value Present SIC (VPSIC)
  ...
  Scenario Outline: LU-6670 - Value Present SIC (VPSIC) Validation for RSI Survey form 7
    ...
    Examples:
      ...
      | 201903 | 49900818161 | 47300 | 1        | Q21      | be                 |
      | 201903 | 49900818161 | 47300 | blank    | Q21      | not be             |
      | 201904 | 49900818161 | 47300 | 0        | Q21      | not be             |
      | 201903 | 49900818161 | 47300 | -2       | Q21      | not be             |
      | 201903 | 49900748571 | 41100 | 1        | Q21      | not be             |
