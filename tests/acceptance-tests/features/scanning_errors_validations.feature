Feature: Scanning Errors Validation
  ...
  Scenario Outline: Sand and Gravel Marine Survey 0076 - Check there is a fixed value validation to numerical fields for illegible values
    ...
    Examples:
      | reference   | survey | period | existingValue | newValue    | fixedValidation                    | isValidationExists |
      | 49900004791 | 0076   | 201903 | blank         | 99999999999 | Value set to default, please check | be                 |
      | 49900004791 | 0076   | 201903 | 1234          | 99999999999 | Value set to default, please check | be                 |
      | 49900004791 | 0076   | 201903 | 99999999999   | 1234        | Value set to default, please check | not be             |
  ...
  Scenario Outline:  Blocks Survey 0073 - Check there is a fixed value validation to numerical fields for illegible values
    ...
    Examples:
      | reference   | survey | period | existingValue | newValue    | fixedValidation                    | isValidationExists |
      | 49900190211 | 0073   | 201905 | blank         | 99999999999 | Value set to default, please check | be                 |
      | 49900190211 | 0073   | 201905 | 1234          | 99999999999 | Value set to default, please check | be                 |
      | 49900190211 | 0073   | 201905 | 99999999999   | 1234        | Value set to default, please check | not be             |
  ...
  Scenario Outline:  Bricks Survey 0074 - Check there is a fixed value validation to numerical fields for illegible values
    ...
    Examples:
      | reference   | survey | period | existingValue | newValue    | fixedValidation                    | isValidationExists |
      | 49900229065 | 0074   | 201905 | blank         | 99999999999 | Value set to default, please check | be                 |
  ...
  Scenario Outline: Blocks Survey 0073 - Check there isn't any fixed value validation to numerical fields for comments field questions
    ...
    Examples:
      | reference   | survey | period | existingValue | newValue    | isValidationExists |
      | 49900190211 | 0073   | 201905 | blank         | 99999999999 | not                |
      | 49900190211 | 0073   | 201905 | 1234          | 99999999999 | not                |
      | 49900190211 | 0073   | 201905 | 99999999999   | 1234        | not                |
