Feature: Sand and Gravel Land Survey - Fixed Value(FV) Validation rule
  ...
  Scenario Outline:  LU-7208 - Check Fixed Value Validation - Sand and Gravel Land Survey
    ...
    Examples:
      ...
      | 49900012765 | 201903 | 99999999999  | Value set to default, please check | be                 |
      | 49900012765 | 201903 | 9999999999   | Value set to default, please check | not be             |
      | 49900012765 | 201903 | 999999999999 | Value set to default, please check | not be             |
      | 49900012765 | 201903 | 0            | Value set to default, please check | not be             |
      | 49900012765 | 201903 | blank        | Value set to default, please check | not be             |
  ...
  Scenario Outline:  LU-7208 - Check Fixed Value Validation - Sand and Gravel Land Survey comment field questions
    ...
    Examples:
      | reference   | period | values      | validation                         | isValidationExists |
      | 49900012765 | 201903 | 99999999999 | Value set to default, please check | not be             |
      | 49900012765 | 201903 | 0           | Value set to default, please check | not be             |
      | 49900012765 | 201903 | blank       | Value set to default, please check | not be             |
