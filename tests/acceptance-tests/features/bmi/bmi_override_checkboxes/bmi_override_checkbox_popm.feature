Feature: BMI Surveys(Blocks,Bricks,Sand Gravel Land and Sand Gravel Marine) - Override checkbox - Period on Period Movement Value(PoPM) Validation rule
  ...
  Scenario Outline: LU-7033 - Period on Period Movement Validation
    ...
    Examples:
      | survey | reference   | currentPeriodValue | previousPeriodValue | previousPeriod | currentPeriod | questionCode | overrideMessage                                                     |
      | 073    | 49900189484 | 20000              | 9999                | 201905         | 201906        | Q102         | Override 'This has changed significantly since the last submission' |
      | 074    | 49900423293 | 2000000            | 999999              | 201905         | 201906        | Q002         | Override 'This has changed significantly since the last submission' |
      | 066    | 49900008900 | 30000              | 9999                | 201903         | 201906        | Q601         | Override 'This has changed significantly since the last submission' |
      | 076    | 49900064408 | 30000              | 9999                | 201903         | 201906        | Q601         | Override 'This has changed significantly since the last submission' |
