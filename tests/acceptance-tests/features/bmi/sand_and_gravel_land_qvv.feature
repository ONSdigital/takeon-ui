Feature: Sand and Gravel Land Survey - Comment Present(Question vs Value) Validation rule
  ...
  Scenario Outline: LU-6403 - Comment Present Validation Sand Gravel land survey on form 1
    Given I search for the survey "0066" with <reference> for the period <period>
