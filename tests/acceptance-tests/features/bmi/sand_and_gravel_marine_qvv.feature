Feature: Sand and Gravel Marine Survey - Comment Present(Question vs Value) Validation rule
  ...
  Scenario Outline: LU-6403 - Comment Present Validation Sand Gravel land survey on form 2
    Given I search for the survey "0076" with <reference> for the period <period>
