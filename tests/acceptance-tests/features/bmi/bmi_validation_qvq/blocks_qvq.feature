Feature: Blocks Survey - Question vs Derived Question (QvQ) Validation rule
  ...
  Scenario Outline: LU-7034 - Question vs Question Validation BMI survey on form 3
    ...
    Examples:
      ...
      | 201905 | 12000138556 | 1,1,1             | be                 | true   | 1            | 2                  |
      | 201905 | 12000138556 | 1,1,3             | be                 | true   | -1           | 2                  |
      | 201905 | 12000138556 | 2,1,1             | not be             | false  | 2            | 2                  |
      | 201905 | 12000138556 | 0,0,0             | not be             | false  | 0            | 0                  |
      | 201905 | 12000138556 | blank,blank,blank | not be             | false  | blank        | blank              |
