Feature: Blocks Survey - Question vs Derived Question (QvQ) Validation rule
  ...
  Scenario Outline: LU-7034 - Question vs Question Validation BMI survey on form 3
    ...
    When I run the validation process for <blocksClosingStock> against the <derivedTotal>
      | closingStockQuestion | derivedQuestion |
      | Q104                 | Q9001           |
    ...
    Examples:
      ...
      | 201905 | 49900138556 | This total is not equal to the derived total | 2,1,1             | be                 | false  | 2            | 2                  |
      | 201905 | 49900138556 | This total is not equal to the derived total | 0,0,0             | be                 | false  | 0            | 0                  |
      | 201905 | 49900138556 | This total is not equal to the derived total | blank,blank,blank | be                 | false  | blank        | blank              |
