class ValidationMessages:
    BMI_MESSAGES = {
        ...
        'iv validation': 'Warning - This is not a valid brick type. '
        ...
        'popzc validation': 'Warning - This is different to the previous submission. '
                            'If this is 0 or blank, '
                            'the previous was greater. If this has a value, the previous was 0 or blank',
    ...
    RSI_MESSAGES = {
        'popmrz validation': 'Error - Internet value(Q21) = 0 this period but > 0 '
                             'last period and ratio of Internet(Q21) to total turnover(Q20) was > 10% last period',
    ...
    TEST_SURVEY_MESSAGES = {
        ...
        'popmrz validation': 'Error - This value is 0. '
                             'Previous period it was more than a certain percentage of the total'
    }
